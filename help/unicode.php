...
<ul>
   <li> UTF-1 – a retired predecessor of UTF-8, maximizes compatibility with ISO 2022, no longer part of The Unicode Standard</li>
   <li> UTF-7 – a 7-bit encoding sometimes used in e-mail, often considered obsolete (not part of The Unicode Standard, but only documented as an informational 
RFC, i.e. not on the Internet Standards Track either)</li>
    <li>UTF-8 – an 8-bit variable-width encoding which maximizes compatibility with ASCII.</li>
    <li>UTF-EBCDIC – an 8-bit variable-width encoding similar to UTF-8, but designed for compatibility with EBCDIC. (not part of The Unicode Standard)</li>
<li>UTF-16 – a 16-bit, variable-width encoding</li>
<li>UTF-32 – a 32-bit, fixed-width encoding</li>
</ul>
</p>
<p>&nbsp;</p>
</div>
